...
<div class="card">
    <div class="card-header d-flex justify-content-end gap-2">
      ...
      <button type="button" class="btn btn-outline-danger" onclick="deleteCard.apply(this, arguments)" id="${taskData.id}">
      <i class="fas fa-dumpster-fire" onclick="deleteCard.apply(this, arguments)"></i>
      </button>
    </div>
...
const saveChanges = () =>{
    const taskData = {
        id: `${Date.now()}`, // unique number for id. To include a JS expression inside we use ${}.
